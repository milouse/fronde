#+title: Fronde config.yml file
#+author: Étienne Deparis
#+lang: en
#+description: Glossary of all possible configuration options for Fronde
#+options: ^:{}

This file explain all possible configuration options for Fronde, which
...
- name :: [string, optional] key used to generate the Org project name.
